  ...
  if (productId) {
    ...
    if (data) {
      ...
      existingUrl.forEach((url) => {
        ...
        const preview = document.getElementById("imageuploads");
        const delbtn = document.createElement("delbtn");
        delbtn.innerHTML = `<button id='delbtn' class="cursor-pointer relative px-2 -top-47 -right-54 w-8 h-8 bg-white/60 rounded-4xl backdrop-blur-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ef4444" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M3 6h18"></path>
              <path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path>
              <path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path>
              <line x1="10" y1="11" x2="10" y2="17"></line>
