  ...
  ProductGrid.innerHTML = products
    ...
    <div class="listing-card flex flex-col relative overflow-hidden rounded-2xl">
      <div class="group flex flex-col relative overflow-hidden rounded-2xl">
        ...
        <a href="../selling/sellingpage.html?id=${product.id}" class="absolute top-3 left-3 bg-white/90 backdrop-blur-sm p-2 rounded-full hover:text-blue-500 transition-colors shadow-sm">
